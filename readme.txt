...
Donate link: https://patreon.com/enricodeleo
...
This plugin targets Magento 2 and it has been specifically tested against Magento 2.4.

= How do I install the plugin? =

You can install the plugin directly from the WordPress plugin repository. After installation, you can import your Magento 2 password hashes into your WordPress database. The password hashes from Magento 2 should be imported in the usual `user_pass` column in `wp_users`.
